 ...
 *
 *"Prostor" reprezentuje jednu místnost ve scénáři hry.
...
public class Prostor implements ISeznamVeci {
    ...
    private Set<Prostor> vychody; //nastavuje sousední místnosti (východy)
    private Map<String, Vec> veci;

    /**
     * Vytvoření prostoru se zadaným popisem, např. "cela", "koupelna", "pradelna"
     *
    ...
    /**
     * Definuje východ z prostoru (sousední prostor). Vzhledem k tomu,
    ...
    public boolean equals(Object o) {
        // porovnává zda se nejedná o dva odkazy na stejnou instanci
        if (this == o) {
            return true;
        }
        // porovnává jakého typu je parametr 
        if (!(o instanceof Prostor)) {
            return false;    // pokud parametr není typu Prostor, vrátíme false
        }
        // přetypuje parametr na typ Prostor 
    ...
    /**
     * Metoda rozhodne, zda je věc v daném prostoru.
     */
    ...
    /**
     * Metoda vrátí "null" při odebrání z prostoru.
     */
    ...
    /**
     * Metoda vrátí "null", pokud je věc odebrána z batohu.
     */
